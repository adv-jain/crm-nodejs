...
function ViewContact({ contact, onClose }) {
  ...
  const leadName = contact.lead
    ? `${contact.lead.firstName || ""} ${contact.lead.lastName || ""}`.trim()
    : "";
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <ReadOnlyField
                label="Industry"
                value={contact.company?.industry}
              />
            </div>
...
// =====================================================
// READ-ONLY FIELD — same look as Form inputs
// =====================================================
function ReadOnlyField({ label, value, icon, pill }) {
